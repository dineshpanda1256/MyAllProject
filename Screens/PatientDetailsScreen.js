...
export default function Callcut() {
        ...
        <View style={styles.mainContainer}>
            <ScrollView showsVerticalScrollIndicator={false}
                ...
                <View>
                    ...
                    <View style={styles.collectviewassume}>
                        ...
                        <View style={styles.collectinside}>
                            <View style={styles.iconview}><Image style={styles.vectoricon} source={require('../Assets/Image/videoicon.png')} /></View>
                            <View>
                                <View><Text style={styles.collectext}>Video Conference</Text></View>
                                <View><Text style={styles.collec2text}>See your doctor live.</Text></View>
                            </View>
                ...
                <View style={{ alignItems: 'center' }}>
                    <LinearGradient
                        colors={['#00E0C5', '#009987']}
                        style={styles.previewbtndiv}>
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate("Doctorvideo");
                            }}
                            style={styles.previewbtn}>
                            <Text style={{ color: '#ffff', fontSize: 18 }}>Start Conference</Text>
                        </TouchableOpacity>
                    </LinearGradient>
                </View>
            </ScrollView>
