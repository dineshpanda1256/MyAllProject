...
import Ordercomp5 from '../Components/Ordercomp5';
import Headingorder1 from '../Components/Heading1';
...
const Orderhistory = () => {
  ...
  return (
    <ScrollView style={styles.contrainer}>
      ...
      {zpi.map(dinesh1 => {
        return <Headingorder1 data={dinesh1} />;
      })}

      {xpi.map(dinesh2 => {
        return <Ordercomp5 data={dinesh2} />;
      })}
    </ScrollView>
  );
};
